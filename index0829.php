      ...
      <div class="collapse navbar-collapse ben-btn-align" id="bs-example-navbar-collapse-1">
          ...
          <a href="#product" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">產品類別<span class="caret"></span></a>
         		 <ul class="dropdown-menu">
            		...
            		<li><a href="#pdt-oil">冷壓初榨橄欖油</a></li>
            		<li><a href="#pdt-sauce">醬料/調味品</a></li>
          		</ul>
        	</li>
...
<div id="about" class="container-fluid">
    ...
    <div class="row">
      ...
      <!-- Wrapper for slides /義大利美食01~05圖片輪播-->
    ...
    <div class="row ben-about-bg ben-about-p" style=" margin-top:2em; margin-left:0.3em; margin-right:0.3em; padding: 0em 0.5em; ">
        <div class="col-xs-11 col-sm-8 col-md-6 col-lg-5">
        <h1 class="ben-about-text01" style="ben-about-sd;" ><a name="about"></a>關於富歐納
        </h1>
...
<div class="container-fluid" style="padding-right:4.5em;">
    ...
    <!--P02: #promotion"/最新促銷 -->
    	<div class="col-xs-12 col-sm-6 col-md-4" >
    		<div  class=" div_align ben-main-bg01" style="background:#33FF99;">
               <ul >
                <h2 style="padding-bottom:0.5em; padding-left:1em; margin-top: 0em;" ><a name="promotion"></a>最新消息</h2>
    ...
    <!--P02: #product"/產品一覽 -->
    		...
    		<div class=" div_align ben-main-bg01 " style="background:#FFF; border:2px solid #F00;">
               <ul>
                <h2 style=" padding-bottom:0.5em; padding-left:-1em; margin-top: 0.5em;"><a name="product"></a>產品一覽</h2>
                <li class="lead"><a name="pdt-pasta"></a>義大利麵條</li>
                <li class="lead"><a name="pdt-aceto"></a>義大利黑醋</li>
                <li class="lead"><a name="#pdt-oil"></a>冷壓初榨橄欖油</li>
            	<li class="lead"><a name="#pdt-sauce"></a>醬料/調味品</li>                   
               </ul>
        	</div>        
    	</div>
    	<div id="bestseller" class="col-xs-12 col-sm-6 col-md-4" >
    		<div class=" div_align ben-main-bg01" style="background-color:#FF0033">
               <ul>
                <h2 style=" padding-bottom:0.5em; padding-left:0em; margin-top: 0em; color:#FFF"><a name="bestseller"></a>熱銷排行榜</h2>
...
<!--P03 Product_Beginning-->
	...
	<div class="container-fluid">
    	...
    	<div class="row" style="background:#009245; background-image:url(images/register01-08.png); background-repeat:no-repeat; background-position:left bottom; background-size:50%; color:#FFF; ">
        	<div class="row">
            <div class="col-xs-12"><h1 style=" text-align:center;"><a name="member-register"></a>會員註冊</h1></div>
			</div>
        	<div class="row">
...
<div class="container-fluid">
	...
	<div class="row ben-footer-bg" style="background-color:#FF6666; color:#FFF; margin-top:2em;">
		...
		<div class="col-xs-12 col-sm-3 ben-footer-align02">
   		<p class="ben-footer-text01"><a name="contact"></a>聯絡我們</p>
