<?php require_once('Connections/spark.php'); ?>
<?php
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "spark_f")) {
  $insertSQL = sprintf("INSERT INTO register (mb_id) VALUES (%s)",
                       GetSQLValueString($_POST['mb_account'], "text"));

  mysql_select_db($database_spark, $spark);
  $Result1 = mysql_query($insertSQL, $spark) or die(mysql_error());

  $insertGoTo = "sendok.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$Recordset1 = mysql_query($query_Recordset1, $spark) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);

echo "<script type='text/javascript'>alert('感謝您的填寫，我們將儘快與您聯絡！');</script>";
...
<html lang="zh-tw">
  ...
  <title>富歐納義大利食材網</title>
	<meta name="description" content="富歐納承習義大利人用心製作美食的堅持, 以天然健康的食材,自然原味百分百來自義大利, 從特色麵條、醬汁,義大利黑醋,一級初搾橄欖油及各區域的美酒佳釀我們都會為你提供,以精選優質	的產品和熱誠服務精神, 竭誠為喜愛美食的你和餐飲美食客户提供服務"><meta name="keywords" content="富歐納 義大利 義大利美食 pasta 天然食材 義大利麵 義大利黑醋 敢攔油 ">
    <!-- Bootstrap -->
  ...
  <!--Nav Button 1,2,3,4,5,6-->
      <div class="collapse navbar-collapse ben-btn-align" id="bs-example-navbar-collapse-1">
  		<ul class="nav navbar-nav ben-nav-btn">
        	...
        	<li class="dropdown">
          <a href="#news" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">最新消息<span class="caret"></span></a>
          		<ul class="dropdown-menu">
...
<div id="about" class="container-fluid">
    ...
    <!--P01_Home_End-->
  <!--P02-Main_Beginning-->
<div id="news" class="container-fluid" style="padding-right:4.5em;">
  ...
  <!--P02_Main_End-->
<form name="spark_f" action="<?php echo $editFormAction; ?>" method="POST"> 
	...
	<div class="container-fluid">
    	...
    	<div class="row" style="background:#009245; background-image:url(images/register01-08.png); background-repeat:no-repeat; background-position:left bottom; background-size:50%; color:#FFF; ">
            ...
            <div class="col-xs-12" style="text-align:center;"><h3>設定會員帳號及密碼</h3></div>
            	...
            	<input name="mb_account" type="text" class="form-control" placeholder="Text input"></div><div class="clearfix"></div> 
            	<div class="col-xs-4 col-sm-5 ben-register-align-tx ">密碼: </div>
            	<div class="col-xs-8 col-sm-7 ben-register-align-blk">
            	<input name="_mb_password" type="password" class="form-control" placeholder="Text input"></div><div class="clearfix"></div> 
            	<div class="col-xs-4 col-sm-5 ben-register-align-tx">確認密碼: </div>
            	<div class="col-xs-8 col-sm-7 ben-register-align-blk ">
                <input name="mb_passwordcfm" type="password" class="form-control" placeholder="Text input"></div><div class="clearfix"></div> 
			</div>
            ...
            <input name="mb_lastname" type="text" class="form-control" placeholder="Text input"></div><div class="clearfix"></div> 
            <div class="col-xs-4 col-sm-3 col-md-2 ben-register-align-tx">名字: </div>
            <div class="col-xs-8 col-sm-9 col-md-10 ben-register-align-blk01 ">
            <input name="mb_firstname" type="text" class="form-control" placeholder="Text input"></div><div class="clearfix"></div> 
            <div class="col-xs-4 col-sm-3 col-md-2 ben-register-align-tx">性別: </div>
            <div class="col-xs-8 col-sm-9 col-md-10 ben-register-align-blk01">
            <select name="mb_gender" class="form-control">
            <option>男</option><option>女</option></select></div>
            <div class="clearfix"></div> 
            <div class="col-xs-4 col-sm-3 col-md-2 ben-register-align-tx">手機: </div>
            <div class="col-xs-8 col-sm-9 col-md-10 ben-register-align-blk01">
            <input name="mb_mobile" type="tel" class="form-control" placeholder="Text input"></div><div class="clearfix"></div> 
            <div class="col-xs-4 col-sm-3 col-md-2 ben-register-align-tx">E-mail: </div>
            <div class="col-xs-8 col-sm-9 col-md-10 ben-register-align-blk01">
            <input name="mb_email" type="email" class="form-control" placeholder="Text input"></div><div class="clearfix"></div> 
            <div class="col-xs-4 col-sm-3 col-md-2 ben-register-align-tx" >地址: </div>
            <div class="col-xs-8 col-sm-9 col-md-10 ben-register-align-blk01">
            	<select name="mb_add_city" class="form-control" style="float:left;">
                  <option>台北市</option>
                  <option>新北市</option>
                  <option>宜蘭縣</option>
                  <option>花蓮縣</option>
			...
			<div class="col-xs-8 col-sm-9 col-md-10 ben-register-align-blk01">
            <input name="mb_add_detail" type="text" type="text" class="form-control" placeholder="Text input"></div><div class="clearfix"></div> 
			<div class="col-xs-4 col-sm-3 col-md-2 ben-register-align-tx">&nbsp;</div>
			<div class="col-xs-8 col-sm-9 col-md-10 ben-register-align-blk">
            <label><input name="mb_signoff" type="checkbox">同意</label>
...
<div class="checkbox">
  <label>
    ...
    我同意個資法
				...
				<button type="submit" class="btn btn-warning" style=" width:6em; border-radius:30px; margin:1em;" >
                確定送出</button>
            	<button type="reset" class="btn btn-info" style=" width:6em; border-radius:30px; margin:1em;">
                重新輸入</button>
            </div>
			</div>
        </div>
	</div>
	<input type="hidden" name="MM_insert" value="spark_f">
</form>
    <!--Register End-->
